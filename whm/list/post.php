...
<article id="post-<?php the_ID(); ?>" class="item">
	<a href="<?php echo $post_url ?>" rel="bookmark"> <img
		src="<?php echo $listImage["url"]; ?>" width="100%"></a>
	<div class="whm-post-info">
		<h2 class="entry-title" style="margin-bottom: 0">
			<a href="<?php echo $post_url; ?>" rel="bookmark style="margin-bottom: 0"><?php the_title(); ?></a>
		</h2>
		...
		<div class="entry-content">
			...
			<a href="<?php echo $post_url; ?>"><span class="btn btn-small"
